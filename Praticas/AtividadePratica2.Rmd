...
```{r}
princ = principal(dados, nfactors = 2, rotate = "varimax", scores = TRUE)
princ
```

Com a matriz rotacionada pelo método varimax, podemos ver que o fator 1 apresenta altas cargas para as variáveis mensuradas em minutos, isto é, as variáveis referentes às provas de 800m, 1500m, 3000m e a maratona. Já o fator 2 tem maiores cargas nas demais variáveis referentes às provas mensuradas em segundos. Então, podemos interpretar esses fatores como:

Fator 1: desempenho em provas de curta distância.

Fator 2: desempenho em provas de longa distância.

<br>

### Ranking por fator 1: Provas de curta distância
