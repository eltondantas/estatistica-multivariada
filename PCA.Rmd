...
Uma vez determinadas as componentes principais, os seus valores numéricos, denominados escores, podem ser clculados para cada elemento amostral. Deste modo, os valores de cada componente podem ser analisados, usando-se técnicas estatísticas usuais como análise de variância e análise de regressão, dentre outras.
